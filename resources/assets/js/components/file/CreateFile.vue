<template>
	<div class="modal fade" id="fileModal"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<!--Modal: Contact form-->
		<div class="modal-dialog cascading-modal" role="document">
			...
			<div class="modal-content">
				...
				<div class="modal-header pink darken-4 white-text">
					<h4 class="title">
						<i class="fa fa-file-archive"></i> Create File </h4>
		...
		export default{
			...
			methods : {
             ...
             getFolder(){
                  ...
                  axios.get(base_url+'find-folder/'+this.form.box)
                  .then(response => {
