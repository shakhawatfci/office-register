...
Component.options.__file = "resources/assets/js/components/file/CreateFile.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5e3994e4", Component.options)
  } else {
    hotAPI.reload("data-v-5e3994e4", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getFolder: function getFolder() {
      ...
      axios.get(base_url + 'find-folder/' + this.form.box).then(function (response) {
    ...
    submit: function submit() {
      ...
      this.submeting = true;
      axios.post(base_url + 'file', this.form).then(function (response) {

        if (response.data.status === 'success') {
          __WEBPACK_IMPORTED_MODULE_0__vue_asset__["EventBus"].$emit('file-created');
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.form.file_name,
                          expression: "form.file_name"
                        }
                      ],
                      staticClass: "form-control form-control-sm",
                      attrs: { type: "text", id: "materialFormNameModalEx1" },
                      domProps: { value: _vm.form.file_name },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(_vm.form, "file_name", $event.target.value)
                        }
                      }
                    }),
                    _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5e3994e4", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/file/ViewFile.vue"
...
Vue.component('create-file', __webpack_require__(44));
Vue.component('view-file', __webpack_require__(47));
